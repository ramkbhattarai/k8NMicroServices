package com.rkb.login.controller;

import com.rkb.login.model.LoginResponse;
import com.rkb.login.model.User;
import com.rkb.login.model.UserDto;
import com.rkb.login.service.AuthenticationService;
import com.rkb.login.service.JwtService;
...
public class AuthenticationController {
    ...
    public ResponseEntity<LoginResponse> authenticate(@RequestBody UserDto loginUserDto) {
        ...
        loginResponse.setIssuedAt(System.currentTimeMillis());
